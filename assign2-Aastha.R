...
daily_power <- function(){
  ...
  #Excecise 3 When the overall demand of the countrywide increases by 20% then p=1.20
  #increasedDemand =0
  #sum =0
  #for(i in 1:length(demand)){
  #  sum = sum + as.numeric(demand[i])
  #}
  #increasedDemand = (sum* 1.20)
  #cat("\n The increased demand after 20% increase countrywide is : ",increasedDemand)
  #end Excecise 3
